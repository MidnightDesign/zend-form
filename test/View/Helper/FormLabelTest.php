...
class FormLabelTest extends CommonTestCase
{
    ...
    public function testOpenTagWithWrongElementRaisesException()
    {
        ...
        $this->expectException('Zend\Form\Exception\InvalidArgumentException', 'ArrayObject');
    ...
    {
        $element = new Element();
        $this->expectException('Zend\Form\Exception\DomainException', 'id');
    ...
    {
        $element = new Element('foo');
        $this->expectException('Zend\Form\Exception\DomainException', 'label');
        $markup = $this->helper->__invoke($element);
    }
